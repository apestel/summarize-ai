...
def summarize_audio(media_filename, llm):
...
def summarize_youtube(url, llm):
    ...
    summarize_audio(media_file + '.wav', llm)
...
if __name__ == '__main__':
    ...
    if args.youtube_url is not None:
        summarize_youtube(args.youtube_url, args.llm)
        exit(0)
    elif args.media_file is not None:
        summarize_audio(args.media_file, args.llm)
        exit(0)
    parser.print_help()
